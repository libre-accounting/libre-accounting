...
return [
    ...
    'invitation' => [
        'message_1'         => 'Você está recebendo este e-mail porque foi convidado a juntar-se ao Libre Accounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalize seu Libre Accounting',
    ],
    ...
    'roles' => [
        ...
        'manager' => [
            'name'          => 'Gerente',
            'description'   => 'Eles têm acesso total ao seu Libre Accounting, mas não podem gerenciar usuários e apps.',
        ],
        'customer' => [
            'name'          => 'Cliente',

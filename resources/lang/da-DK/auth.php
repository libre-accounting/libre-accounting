...
return [
    ...
    'invitation' => [
        'message_1'         => 'Du modtager denne e-mail, fordi du er inviteret til at deltage i Libre Accounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Tilpas din Libre Accounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'De får fuld adgang til din Libre Accounting herunder kunder, fakturaer, rapporter, indstillinger og apps.',
        ],
        'manager' => [
            'name'          => 'Leder',
            'description'   => 'De får fuld adgang til din Libre Accounting, men kan ikke administrere brugere og apps.',
        ],
        'customer' => [
            'name'          => 'Kunde',

...
return [
    ...
    'invitation' => [
        'message_1'         => 'Sie erhalten diese E-Mail, weil Sie zur zusammenarbeit bei Libre Accounting eingeladen wurden.',
    ...
    'information' => [
        ...
        'customize'         => 'Passen Sie Ihr Libre Accounting an',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Sie erhalten vollen Zugriff auf Libre Accounting, einschließlich Kunden, Rechnungen, Berichte, Einstellungen und Apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'Sie erhalten vollen Zugriff auf Libre Accounting, können aber keine Benutzer und Apps verwalten.',
        ],
        'customer' => [
            'name'          => 'Kunde',

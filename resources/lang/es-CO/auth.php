...
return [
    ...
    'invitation' => [
        'message_1'         => 'Estás recibiendo este correo electrónico porque estás invitado a unirte a Libre Accounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Personaliza tu Libre Accounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrador',
            'description'   => 'Obtendrán acceso total a Libre Accounting incluyendo clientes, facturas, informes, ajustes y aplicaciones.',
        ],
        'manager' => [
            'name'          => 'Gerente',
            'description'   => 'Obtendrán acceso total a tu Libre Accounting, pero no pueden administrar usuarios y aplicaciones.',
        ],
        'customer' => [
            'name'          => 'Cliente',

...
return [
    ...
    'messages' => [
        'export_started'    => 'La copia de seguridad ha comenzado. Se te notificará cuando la descarga esté lista.',
        'exporting'         => 'Creando la copia de seguridad de la empresa…',
        'export_completed'  => 'La copia de seguridad de la empresa está lista.',
        'import_started'    => 'La restauración ha comenzado. Esto puede tardar un rato en copias de seguridad grandes.',
    ...
    'warnings' => [
        ...
        'disabled_modules'      => 'La copia de seguridad hace referencia a estos módulos, pero no están instalados aquí, por lo que quedaron deshabilitados: :modules.',
        'skipped_reports'       => 'Se omitieron :count informe(s) porque su tipo de informe no está instalado en esta instancia.',
        'unbundled_media'       => ':count archivo(s) estaban almacenados en un almacenamiento remoto y no se incluyeron; vuelve a subirlos manualmente.',
        'missing_currency_refs' => ':count registro(s) hacían referencia a una moneda que no estaba en la copia de seguridad y se usó la moneda predeterminada en su lugar.',
    ],

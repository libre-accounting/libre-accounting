...
return [
    ...
    'invitation' => [
        'message_1'         => 'Получавате този имейл, защото сте поканени да се присъедините към Libre Accounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Персонализирайте вашия Libre Accounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Администратор',
            'description'   => 'Те получават пълен достъп до вашия Libre Accounting, включително клиенти, фактури, отчети, настройки и приложения.',
        ],
        'manager' => [
            'name'          => 'Мениджър',
            'description'   => 'Те получават пълен достъп до вашия Libre Accounting, но не могат да управляват потребители и приложения.',
        ],
        'customer' => [
            'name'          => 'Клиент',

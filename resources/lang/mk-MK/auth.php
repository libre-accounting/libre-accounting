...
return [
    ...
    'invitation' => [
        'message_1'         => 'Ја добивате оваа е-пошта затоа што сте поканети да се придружите на Libre Accounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Прилагодете го вашиот Libre Accounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Админ',
            'description'   => 'Тие добиваат целосен пристап до вашиот Libre Accounting вклучувајќи клиенти, фактури, извештаи, поставки и апликации.',
        ],
        'manager' => [
            'name'          => 'Менаџер',
            'description'   => 'Тие добиваат целосен пристап до вашиот Libre Accounting, но не можат да управуваат со корисници и апликации.',
        ],
        'customer' => [
            'name'          => 'Клиент',

...
return [
    ...
    'invitation' => [
        'message_1'         => 'Jūs saņēmāt šo e-pasta ziņojumu, jo esat uzaicināts pievienoties Libre Accounting.',
    ...
    'information' => [
        ...
        'customize'         => 'Pielāgojiet savu Libre Accounting',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrators',
            'description'   => 'Viņi iegūst pilnu piekļuvi jūsu Libre Accounting, tostarp klientiem, rēķiniem, pārskatiem, iestatījumiem un lietotnēm.',
        ],
        'manager' => [
            'name'          => 'Vadītājs',
            'description'   => 'Viņi iegūst pilnu piekļuvi jūsu Libre Accounting, taču nevar pārvaldīt lietotājus un lietotnes.',
        ],
        'customer' => [
            'name'          => 'Klients',

        ...
        @else
            <div class="flex">
                <div class="w-full text-center">
                    ...
                    <div class="my-10">
                        <x-link
                            href="https://libreaccounting.org/accounting-software?utm_source=software&utm_medium=invoice_index&utm_campaign=plg"
                    ...
                    <div class="my-10">
                        <img src="{{ asset('public/img/portal/invoice.gif') }}" class="inline" alt="Get Started" />
                    </div>
                </div>
            </div>
